...
public class KeyValueDisplayFileSystem extends VirtualFileSystem {
  ...
  public void openEditor(KeyValueDisplayVirtualFile keyValueDisplayVirtualFile) {
    FileEditorManager fileEditorManager =
        FileEditorManager.getInstance(keyValueDisplayVirtualFile.getProject());
  ...
  protected void moveFile(
      Object o, @NotNull VirtualFile virtualFile, @NotNull VirtualFile virtualFile1)
      throws IOException {}

  @Override
  protected void renameFile(Object o, @NotNull VirtualFile virtualFile, @NotNull String s)
      throws IOException {}

  @Override
  protected @NotNull VirtualFile createChildFile(
      Object o, @NotNull VirtualFile virtualFile, @NotNull String s) throws IOException {
    return null;
  }

  @Override
  protected @NotNull VirtualFile createChildDirectory(
      Object o, @NotNull VirtualFile virtualFile, @NotNull String s) throws IOException {
    return null;
  }

  @Override
  protected @NotNull VirtualFile copyFile(
      Object o,
      @NotNull VirtualFile virtualFile,
      @NotNull VirtualFile virtualFile1,
      @NotNull String s)
      throws IOException {
    return null;
  }
