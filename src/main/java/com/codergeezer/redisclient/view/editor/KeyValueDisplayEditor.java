...
public class KeyValueDisplayEditor extends UserDataHolderBase implements FileEditor {
  ...
  private final KeyValueDisplayVirtualFile keyValueDisplayVirtualFile;
  ...
  public @NotNull JComponent getComponent() {
    return keyValueDisplayVirtualFile.getKeyValueDisplayPanel();
  }
  ...
  @Override
  public void dispose() {
    keyValueDisplayVirtualFile
        .getConnectionManager()
        .removeEditor(
            keyValueDisplayVirtualFile.getServerConfiguration(), keyValueDisplayVirtualFile);
  }
}
