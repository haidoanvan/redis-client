...
import com.codergeezer.redisclient.view.ConsolePanel;
...
public class ConsoleVirtualFile extends VirtualFile {
  ...
  public ConsoleVirtualFile(
    ...
    this.consolePanel = new ConsolePanel(project, serverConfiguration, redisManager);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(serverConfiguration);
  }
