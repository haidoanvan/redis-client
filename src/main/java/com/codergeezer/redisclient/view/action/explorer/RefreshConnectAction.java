 ...
 * @version 1.0
 */
public class RefreshConnectAction extends AnAction {

  private final ConfigurationHelper configurationHelper;

  private final Tree connectionTree;

  public RefreshConnectAction(ConfigurationHelper configurationHelper, Tree connectionTree) {
  ...
  public void actionPerformed(@NotNull AnActionEvent anActionEvent) {
    configurationHelper.refreshConnectHandle(
        connectionTree,
        configurationHelper.getConfigurationTreeModel(),
        configurationHelper.getConfigurationTreeLoadingDecorator());
  }
